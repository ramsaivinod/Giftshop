...
function Footer() {
  return (
    <Box backgroundColor="#171381" style={{ backgroundImage: `url(${images})` }}>
        ...
        <div className="row content" style={{ marginTop: '50px' }}>
          <div className="col-sm-12 col-md-5">
            <Box className="full-address">
              <Typography className="htxt">Contact Us</Typography>
              {/* Contact information */}
              ...
              <Typography
                ...
                color="white"
                style={{ fontSize: '16px', lineHeight: '24px', marginBottom: '10px' }}>
            ...
            {/* Links for donation, volunteering, and login */}
            <div className="donate-login-vol">
              <ul>
                <li>
                  <a href="https://jkyog.org/donate" target="_blank" title="Donate Page Url">
                    <img
                      src="https://www.jkyog.org/themes/custom/jkyog/images/donate.png"
                      alt="Donate"
                      title="Donate"
                    />
                    <br />
                ...
                <li>
                  <a href="https://www.jkyog.org/volunteer" target="_self" title="Volunteer Page Url ">
                    <img
                      src="https://www.jkyog.org/themes/custom/jkyog/images/volunteer.png"
                      alt="Volunteer"
                      title="Volunteer"
                    />
                    <br />
                ...
                <li>
                  <a href="https://login.jkyog.org/user/login" title="Login Page Url" style={{ lineHeight: '25px' }}>
                    <img src="https://www.jkyog.org/themes/custom/jkyog/images/login.png" alt="Login" title="Login" />{' '}
                    <br />
                    Login
                  </a>
                </li>
          ...
          <div className="col-sm-12 col-md-3 programs-center">
            <Box>
              ...
              <ul style={{ color: '#ff6d2f' }}>
                ...
                <li>
                  <a href="https://www.jkyog.org/retreats" target="_blank" rel="noreferrer">
                    <Typography color="white" textAlign={'left'}>
                      {' '}
                      JKYOG Retreats
                    </Typography>
                ...
                <li>
                  <a href="https://www.jkyog.org/bal-mukund" target="_blank" rel="noreferrer">
                    <Typography color="white" textAlign={'left'}>
                      {' '}
                      Bal-Mukund
                    </Typography>
                ...
                <li>
                  <a href="https://www.jkyog.org/jkyog-youth-club" target="_blank" rel="noreferrer">
                    <Typography color="white" textAlign={'left'}>
                      {' '}
                      JKYog Youth Club
                    </Typography>
